...
def detectar_rostros(video_capture):
    ...
    colores = [(255, 0, 255), (0, 255, 0), (255, 255, 0)]  
    color_index = 0
    ...
    while True:
        ...
        if len(faces) > 0 and not mostrando_resultado:
            ...
            cv2.rectangle(frame, (x, y), (x+w, y+h), colores[color_index], 2)
...
def main():
    ...
    video_capture.set(cv2.CAP_PROP_FRAME_WIDTH, 640)  # Cambiar resolución a 640x480 para una relación 4:3
